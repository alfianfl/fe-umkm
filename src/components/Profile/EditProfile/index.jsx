...
import { editUserAPI, getUserAPI } from '../../../models/UserAPI';
import './style.scss';
        ...
        <div className="flex flex-col form-body ">
          ...
          <div className="form-input flex items-center bg-white rounded mb-4">
            ...
            <input
              ...
              name="tanggal_lahir"
              onChange={inputChangeHandler}
              value={inputValue.tanggal_lahir}
